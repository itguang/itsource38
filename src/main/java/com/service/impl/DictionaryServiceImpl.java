...
//            ServletContext servletContext = ContextLoader.getCurrentWebApplicationContext().getServletContext();
            ...
            Map<String, Map<Integer, String>> dictionaryMap= getStringMapMap();
    ...
    private Map<String, Map<Integer, String>> getStringMapMap() {
        List<DictionaryEntity> dictionaryEntities = selectList(new EntityWrapper<DictionaryEntity>());
