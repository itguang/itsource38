...
public class DictionaryServletContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        Map<String, Map<Integer, String>> map = getStringMapMap(appContext);
    ...
    private static Map<String, Map<Integer, String>> getStringMapMap(ApplicationContext appContext) {
